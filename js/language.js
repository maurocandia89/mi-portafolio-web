document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        es: {
            ...
            "milestones.educationDescription0": "Estudié y completé el plan de estudios para la carrera de Ingeniería Industrial, en la cual obtuve el título de Técnico Industrial.",
            ...
            "milestones.educationDescription1": "Curso de Fundación Proydesa-Proyectos y Desarrollos Argentinos.",
            "milestones.educationTitle2": "Técnico Universitario en Desarrollo de Software",
            "milestones.educationSchool2": "Universidad Tecnológica Nacional Facultad Regional Mendoza",
            "milestones.educationDescription2": "Completé mi formación en la UTN, donde me enfoqué en dominar tecnologías de front-end y back-end, combinando la teoría con la práctica de los principios clave del desarrollo de software.",
            "milestones.educationTitle3": "Curso de Inglés B1",
            "milestones.educationSchool3": "Universidad Nacional de Cuyo, Idiomas UNCuyo",
            "milestones.educationDescription3": "Aprobé el examen de Nivel B1 plus de Inglés, administrado por la Facultad de Filosofía y Letras de la Universidad de Cuyo.",
             "milestones.educationTitle4": "Curso de Inglés B2",
            "milestones.educationSchool4": "Universidad Nacional de Cuyo, Idiomas UNCuyo",
            "milestones.educationDescription4": "Aprobé el examen de Nivel B2 de Inglés, administrado por la Facultad de Filosofía y Letras de la Universidad de Cuyo.",
            ...
            "projects.descriptions.pokédex": "Sitio web responsivo que utiliza la API oficial de Pokémon, permitiendote ver el listado y poder elegir tus pokémons favoritos.",
        },
        en: {
            "nav.home": "Home",
            "nav.about": "About me",
            ...
            "milestones.educationDescription0": "I studied and completed the coursework for the Industrial Engineering degree, in which I obtained the title of Industrial Technician.",
            ...
            "milestones.educationDescription1": "Proydesa Foundation Course - Argentine Projects and Developments.",
            "milestones.educationTitle2": "University Technician in Software Development",
            "milestones.educationSchool2": "National Technological University Regional Faculty of Mendoza",
            "milestones.educationDescription2": "I completed my degree at UTN, focusing on mastering front-end and back-end technologies. My training combined theoretical knowledge with a strong emphasis on core software development principles.",
            "milestones.educationTitle3": "B1 English Course",
            "milestones.educationSchool3": "National University of Cuyo, Languages UNCuyo",
            "milestones.educationDescription3": "I passed the B1 English level exam, administered by the Faculty of Philosophy and Letters of the University of Cuyo.",
            "milestones.educationTitle4": "B2 English Course",
            "milestones.educationSchool4": "National University of Cuyo, Languages UNCuyo",
            "milestones.educationDescription4": "I passed the B2 English level exam, administered by the Faculty of Philosophy and Letters of the University of Cuyo.",
            ...
            "projects.descriptions.pokédex": "Responsive website that uses the official Pokémon API, allowing you to view the list and choose your favorite Pokémon.",
        },
    };
